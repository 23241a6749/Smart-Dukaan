...
const DefaulterCard = React.memo(({ customer, onRecover }: { customer: any, onRecover: (customer: any) => void }) => {
    const { t } = useLanguage();
    return (
        <div className="bg-white dark:bg-[#111111] p-5 rounded-[1.5rem] border border-gray-100 dark:border-white/5 shadow-sm flex items-center justify-between hover:border-primary-green/30 transition-all hover:bg-gray-50 dark:hover:bg-white/[0.02] group relative overflow-hidden">
            ...
            <div className="flex items-center gap-4 relative z-10 flex-1">
                ...
                <div className="flex flex-col min-w-0">
                    ...
                    <div className="flex items-center gap-2">
                        <span className="text-primary-green font-black text-sm font-mono w-20 shrink-0">
            ...
            <div className="relative z-10 ml-4 shrink-0">
                <button
                    ...
                    className="h-10 px-3 md:px-6 rounded-xl font-black text-[10px] uppercase tracking-widest flex items-center gap-1 md:gap-2 transition-all active:scale-95 bg-primary-green text-white shadow-lg shadow-primary-green/20 hover:bg-green-600"
                >
